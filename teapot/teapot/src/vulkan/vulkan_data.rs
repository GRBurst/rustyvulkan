...
fn load_model() -> (Vec<Model>, Result<Vec<Material>, tobj::LoadError>){
   //let (models, materials) =
     return tobj::load_obj(
            "teapot.obj",
...
impl VulkanData {
    pub fn new(vulkan_base: &mut VulkanBase) -> Result<Self, String> {
        ...
        let (models, materials) = load_model();
        ...
        let control_points_mem_buffer_sg = {
            let control_points_mem_buffer = vulkan_utils::create_gpu_buffer_init(
                ...
                *allocator_rc.borrow_mut(),
                ...
                vulkan_base.queue,
                bytemuck::cast_slice(&models[0].mesh.positions),
